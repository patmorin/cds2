...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=1]{critical}
...
\begin{figure}
  \centering
  \begin{tabular}{ccc}
    \includegraphics[page=1]{minimal} &
    \includegraphics[page=3]{minimal} &
    \includegraphics[page=5]{minimal} \\
    $\Downarrow$ & $\Downarrow$ & $\Downarrow$ \\
    \includegraphics[page=2]{minimal} &
    \includegraphics[page=4]{minimal} &
    \includegraphics[page=6]{minimal}
  \end{tabular}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{chord_incident}
...
\begin{proof}
  ...
  % Consider the face $f:=v_0,\ldots,v_{k-1}$ of the outerplane graph $H[B(H)]$ that contains $w$.
   ...
   \begin{figure}[htbp]
     \centering
     \begin{tabular}{ccc}
       \includegraphics[page=1]{outer_2_2} &
       \includegraphics[page=2]{outer_2_2} &
       \includegraphics[page=3]{outer_2_2}
     \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[page=1]{2_3_figure}
  \includegraphics[page=2]{2_3_figure}
  \includegraphics[page=3]{2_3_figure}
...
\begin{proof}
  ...
  \begin{figure}[htbp]
    \centering
    \begin{tabular}{ccc}
      \includegraphics[page=1]{killing_a_leaf} &
      \includegraphics[page=2]{killing_a_leaf} &
      \includegraphics[page=3]{killing_a_leaf} \\
      $H$ & $H-v$ & $H'$
    \end{tabular}
...
\begin{figure}[htpb]
  \centering
  \begin{tabular}{cc}
    \includegraphics[page=1]{isolated} &
    \includegraphics[page=3]{isolated} \\
    $\Downarrow$ & $\Downarrow$ \\
    \includegraphics[page=2]{isolated} &
    \includegraphics[page=4]{isolated}
  \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[page=1]{two_critical}
...
\begin{figure}
  \centering
  \includegraphics[page=7,trim={0 55 0 10},clip]{two_critical}
...
\begin{figure}
  \centering
  \begin{tabular}{ccc}
    \includegraphics[page=1]{biconnected} &
    \includegraphics[page=2]{biconnected} &
    \includegraphics[page=3]{biconnected} \\
    $H$ & $H'$ & $H$
  \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[page=2]{two_critical}
...
\begin{figure}
  \centering
  \includegraphics[page=4]{two_critical}
...
\begin{figure} [htbp]
  \centering
  \includegraphics[page=6]{proper_good} \\
  $\Downarrow$ \\
  \includegraphics[page=7]{proper_good}
...
\begin{figure}
    \centering
    % \includegraphics[page=2]{proper_good} \\
    % $\Downarrow$ \\
    \includegraphics[page=3]{proper_good}\\
    $\Downarrow$ \\
    \includegraphics[page=4]{proper_good}
...
\begin{proof}[Proof of \cref{really_good}]
  ...
  \begin{figure}
    \centering
    \begin{tabular}{ccc}
      \includegraphics[page=1]{really_good} &
      \includegraphics[page=2]{really_good} &
      \includegraphics[page=3]{really_good}
    \end{tabular}
    \caption{The proof of \cref{really_good}.
    % \hussein{I think, it might be better if we draw another neighbor of w to its right.}\pat{No, the third figure illustrates something that is not possible (the edge $v_0z$). The third neighbour of $w$ is $z$}
    }
...
\begin{proof}[Proof of \cref{critical}]
  ...
  \begin{figure}[htbp]
    \centering
    \begin{tabular}{cc}
      \includegraphics[page=1,trim={30 0 30 0},clip]{critical_3_colouring} &
      \includegraphics[page=2]{critical_3_colouring}
    \end{tabular}
