...
\begin{thm}\label{main_result2}
  For any $n\ge 4$, any $n$-vertex triangulation $G$ has a connected dominating set $X$ of size at most $(7n-12)/15$ and there exists an algorithm that finds $X$ in linear time.
\end{thm}
