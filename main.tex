...
\pat{The insertion of $v$ into $\beta$ can be done in $O(\deg_G(v))$ time by starting at the small end of the list and stopping when we get to the correct bucket.  I added a note about this in the paragraph that describes $\beta$ and $\zeta$.}
