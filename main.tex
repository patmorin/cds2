...
\begin{cor}\label{boundary_vs_leaves}
  Let $H$ be a $2$-critical generalized near-triangulation and let $\ell$ be the number of degree-$1$ vertices in $H-B(H)$ \pat{Need condition on size of $H-B(H)$}. Then $\sum_{i=1}^k |W_i|\ge |B(H-B(H))|+\ell$.
\end{cor}
