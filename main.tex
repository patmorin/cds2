...
\pat{To see the problem, imagine the algoritm runs for $r=1000$ iterations, taking a degree-$3$ vertex at each step.  After $r$ iterations, what's left is a $2$-critical graph $G_r$ with $|B(G_r)|=2000$ and $|I(G_r)|=1000$. Then $n=|G|=|X|+|G_r|=1000+3000=4000$ and $|X|=r+|G_r|/3=2000$, so $|X|/n=1/2$.}

\pat{The underlying issue is the contribution of $V_1(C)$ for the components $C\in\overline{C}$.  }
