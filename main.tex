...
\begin{proof}
  ...
  \end{clmproof}
  Therefore, \cref{a1,a2,a3} are three inequalities in three non-negative variables $x_2$, $z$, and $|I_{r-1}|$.  Again, this is an easy linear programming exercise that gives $x_2:=(3n-6)/13$, $z=(3n-19)/13$ and $I_{r-1}=(n+11)/13$.  \url{https://www.wolframalpha.com/input?i=solve%28%7Bx%3Dz%2B1%2C+3%2B2*x%2B2*z%2By%3Dn%2C+3%2Bx%3D3*y%7D%29+}....
