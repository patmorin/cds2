...
\begin{figure}
  \begin{center}
      \includegraphics[page=2]{figs/bg_layers.pdf} \\[-5ex]
      $G[R\cup S]$ \\[-1ex]
      \includegraphics[page=3]{figs/bg_layers.pdf} \\[-3ex]
      $G[Q\cup R\cup S]$ \\[2ex]
      \includegraphics[page=4]{figs/bg_layers.pdf} \\[-.7ex] 
...
\begin{proof}
  ...
  Let $B:=|B(G_{r-1})|$, let $Q:=|B(G_{r-1}-B(G_{r-1}))|$, let $R:=|I(G_{r-1}-B(G_{r-1}))|$, and let $S:=|I(G_{r-1}-B^2(G_{r-1}))|$.\pat{Define $B^2(G)=G[B(G-B(G))]-B(G[B(G-B(G))])$}  Then, by \cref{degree_corners_and_leaves} and \cref{base_case}
