...
\begin{frame}
  ...
  \begin{center}
    ...
    $G_1$ & $G_2$
  \end{tabular}
    \uncover<2->{\includegraphics[page=3,scale=.8]{figs/sefenomap}}
  \end{center}
...
\begin{frame}
  ...
  \only<2>{\includegraphics[page=2]{figs/universal}}%
  \only<3>{\includegraphics[page=3]{figs/universal}}%
  \only<4>{\includegraphics[page=4]{figs/universal}}%
  \only<5>{\includegraphics[page=5]{figs/universal}}%
  \only<6>{\includegraphics[page=6]{figs/universal}}%
  \only<7->{\includegraphics[page=7]{figs/universal}}%


  \uncover<8->{\textbf{Theorem (Bose-Dujmović-Da~Lozza-Hurtado-Langerman-Mchedlidze--M-Roselli-Rote-Wood 2009--2021):} Every $n$-vertex planar graph $G$ has a free set of size $\Omega(\sqrt{n})$.\\[1em]
...
\begin{frame}
  \frametitle{Surface Triangulations}

  \textbf{Theorem:} For any $g<n$ every $n$-vertex genus-$g$ surface triangulation has a connected dominating set of size at most $10n/21 + O(\sqrt{gn})$.
...
\begin{frame}
  \frametitle{Summary}
    ...
    \begin{center}
      ...
      maximimum induced outerplane graph ${}\ge 11n/21$ \\
    \end{center}
...
\begin{frame}
  \frametitle{Open Problem: CDS in edge-maximal beyond-planar classes}
    ...
    \begin{center}
      \includegraphics[page=1]{figs/nover3}
    \end{center}
